...
app.post("/addProduct",upload.single("ProductPic"), ProductController.addProduct, async (req, res) => {
  let resp = req.resp;
  if (resp.success) {
    res.redirect("/admin");
  } else {
...
app.post("/updateProduct",upload.single("ProductPic"), ProductController.updateProduct, async (req, res) => {
  let resp = req.resp;
  if (resp.success) {
    res.redirect("/admin");
  } else {
